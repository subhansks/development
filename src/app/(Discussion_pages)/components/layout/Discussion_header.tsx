    ...
    return (
        <div className='pt-6 flex justify-between md:flex-row flex-col gap-4 '>
            ...
            <div className=' flex  h-fit '>
                <Link className='font-semibold py-3 px-8 text-sm font-open_sans text-dealguru-white bg-dealguru-blue rounded-md md:w-fit w-full text-center' href={''}>Lägg till diskussion</Link>
            </div>
