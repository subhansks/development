    ...
    return (
        <div className='w-full  bg-dealguru-white shadow-md shadow-gray-200 rounded-md px-6 py-4 flex  gap-4'>
            ...
            <div className='flex flex-col gap-2'>
                ...
                {!details ? (<Link href={`/diskussion/${'Bästa deal du hittat ? Som du är nöjd med ?'}`}>
