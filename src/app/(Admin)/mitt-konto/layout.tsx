          ...
          >
            {navItems.map((item, index) => (
              <li
                key={index}
                className={clsx(
                  "flex items-center bg-dealguru-white hover:bg-gray-300 mb-2.5 rounded-md transition-colors duration-300 ease-in-out",
                  {
              ...
              >
                <Link
                  href={item.href}
                  className="flex items-center w-full px-5 py-[7px] no-underline text-sm"
                >
                  <Image
