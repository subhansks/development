  ...
  return (
    <div className="flex flex-wrap">
      {blogs.map((blog, index) => (
        <div key={index} className="bg-dealguru-white mr-4 w-[350px] p-4  rounded-lg shadow-lg shadow-gray-190 flex flex-col justify-center gap-4 dealguru-bottom-card">
          ...
          <div className='flex items-center gap-4'>
              ...
              <div>
                  <h4 className='text-gray-800 font-semibold text-xs'>DealGuru-{blog.user_name}</h4>
                  <p className='text-gray-400 text-xs'>{blog.user_date}</p>
              </div>
          </div>
        </div>
      ))}
