...
const Footer = () => {
  return (
    <>
      ...
      <div className="grid gap-4 lg:gap-2 grid-cols-2 md:grid-cols-3  lg:grid-cols-4 bg-dealguru-white w-full 2xl:px-x-pad md:px-8 px-4 md_lg:grid-cols-6 mt-4 items-start py-8 text-sm ">
